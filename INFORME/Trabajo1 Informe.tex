...
\begin{figure}[!htb]
  ...
  \caption{Simulaciones en R de la distribución Poisson($\lambda=1$) con muestras de tamaño ($n=1$), ($n=5$), ($n=10$), ($n=30$))}\label{figura1}
\end{figure}
...
\begin{center}
	\begin{tabular}{ccccccccc}
		...
		\rule[-1ex]{0pt}{2.5ex}  Parametro & W & P-Valor & W & P-Valor & W & P-Valor & W & P-Valor \\ 
		\hline  
		\rule[-1ex]{0pt}{2.5ex}  ($a=0,b=1$) & 34.305 & 0.00003161 & 44.849 & 0.0002001 & 123.58 & 0.01235 & 186.76 & 0.03106\\ 
		
		\rule[-1ex]{0pt}{2.5ex}  ($a=9,b=4$) &  1119.3 & 0.2254 & 1664.4 & 0.2805 & 11666.7 & 0.2806 & 1666.7 & 0.2806 \\ 
		
		\rule[-1ex]{0pt}{2.5ex}  ($a=15,b=6$) & 1254.3 & 0.2411 & 1666.6 & 0.2806 & 1666.7 & 0.2806 & 1666.7 & 0.2806 \\ 
		\hline 
	\end{tabular} 
\end{center}
